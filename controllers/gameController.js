...
// Encrypt and decrypt for custom games
const alphabet = ['a','b','c','d','e','f','g','h','i','j','k','l','m',
    'n','o','p','q','r','s','t','u','v','w','x','y','z'];

exports.encryptWord = (word) => {
...
exports.decryptWord = (encryptedWord) => {

    let decrypted = "";

    decrypted += alphabet[(alphabet.indexOf(encryptedWord[0]) + 12) % 26];
    decrypted += alphabet[(alphabet.indexOf(encryptedWord[1]) + 11) % 26];
    decrypted += alphabet[(alphabet.indexOf(encryptedWord[2]) + 10) % 26];
    decrypted += alphabet[(alphabet.indexOf(encryptedWord[3]) + 9) % 26];
    decrypted += alphabet[(alphabet.indexOf(encryptedWord[4]) + 8) % 26];
